...
# 당신은 한 스타트업의 데이터 엔지니어입니다. 고객 정보 서버가 해킹을 당해 일부 정보가 손상되었습니다. 다행히
# 튜플 형태로 백업된 데이터가 남아 있으며, 이를 기반으로 정확한 정보를 복원하고 분석해야 합니다.
...
print(f"restored_user의 name: {name}, age: {age}, city: {city}")
...
users = ("minji", "eunji", "soojin", "minji", "minji")
print(f'"minji" 이름 등장 횟수: {users.count("minji")}')
print(f'"soojin" 이름 처음 등장 위치: {users.index("soojin")}')
