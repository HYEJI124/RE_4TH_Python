...
empty_tuple = ()
numbers = (1, 2, 3, 4, 5)
# mixed = (1, "hello", 3.14, True) # 여러 타입 사용 가능
...
tuple_with_list[0].append(3) # 튜플 안의 요소인 리스트에 추가하는 건 가능
print('tuple_with_list:', tuple_with_list)
# tuple_with_list[0] = [2, 3] (튜플 안의 리스트 자체를 바꾸는 건 불가능)
# 방 안의 상자 존재. 상자 자체는 변경 불가능한데 상자 안의 물품은 교체 가능한 개념
