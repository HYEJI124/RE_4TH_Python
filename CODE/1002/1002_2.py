...
daily_sales = pd.Series([
    302, 301, 495, 694, 498, 496,
    732, 324, 547, 794, 391, 491,
    912, 823, 722, 262, 651, 231,
    456, 371, 857, 960, 182, 585,
    123, 167, 393, 192, 404, 585
],
...
print(f'4. 분산 (variance): {variance:.2f}') # :.소수점자리수f

# 표준편차 (Standard Deviation): 분산의 제곱근
std_dev = daily_sales.std()
print(f'5. 표준편차 (Standard Deviation): {std_dev:.2f}') # :.소수점자리수f
