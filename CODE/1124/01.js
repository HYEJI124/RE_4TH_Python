...
// 영문자, 숫자, _, $ 사용 가능
// 숫자로 시작 불가
// camelCase 권장(첫 단어 시작: 소문자, 다음 단어 시작: 대문자)
// snake_case: _사용
...
console.log(typeof name3); // type: string

// 불리언(boolean)
const isStudent1 = true;
const isTeacher = false;

console.log(typeof isStudent1); // type: boolean
